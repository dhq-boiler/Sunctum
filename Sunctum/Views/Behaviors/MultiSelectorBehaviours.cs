...
namespace Sunctum.Views.Behaviors
{
    /*
     * https://github.com/samueldjack/SelectedItemsBindingDemo
     * Samuel Jack https://github.com/samueldjack
     */
    ...
    public static class MultiSelectorBehaviours
    {
        ...
        private static readonly DependencyProperty s_synchronizationManagerProperty = DependencyProperty.RegisterAttached(
        ...
        {
            return (SynchronizationManager)dependencyObject.GetValue(s_synchronizationManagerProperty);
        }

        private static void SetSynchronizationManager(DependencyObject dependencyObject, SynchronizationManager value)
        {
            dependencyObject.SetValue(s_synchronizationManagerProperty, value);
        }
