...
{
    internal class GreaterThanOrEqualToSyntax<R> : SyntaxBase, IOperatorSyntax<R>, IOperatorColumnSyntax<R> where R : class
    {
        internal GreaterThanOrEqualToSyntax(SyntaxBase syntaxBase)
            : base(syntaxBase)
        { }
